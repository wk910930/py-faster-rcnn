...
class StageBridgeLayer(caffe.Layer):
    ...
    def forward_train(self, bottom, top):
        ...
        labels, rois_out, fg_inds, mask_targets, top_mask_info, bbox_targets, bbox_inside_weights = \
            _sample_output(all_rois, gt_boxes, im_info[2], gt_masks, mask_info, self._num_classes)
...
def _sample_output(all_rois, gt_boxes, im_scale, gt_masks, mask_info, num_classes):
    ...
    return labels, rois, fg_inds, pos_masks, top_mask_info, bbox_targets, bbox_inside_weights
