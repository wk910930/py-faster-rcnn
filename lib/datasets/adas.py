...
class adas(imdb):
    ...
    def _load_image_set_index(self):
        ...
        # self._devkit_path + /ADASdevkit2007/ADAS01/ImageSets/Main/val.txt
    ...
    def _get_default_path(self):
        """
        Return the default path where ADAS is expected to be installed.
        """
        return os.path.join(cfg.DATA_DIR, 'ADASdevkit')
    ...
    def _load_custom_roidb(self, gt_roidb):
        ...
        for i, index in enumerate(self._image_index):
            ...
            box_file = osp.join(
                cfg.DATA_DIR, 'adas_proposals', 'ADAS' + self._year, 'custom', 'mat',
    ...
    def _get_voc_results_file_template(self):
        # ADACdevkit/results/ADAS01/Main/<comp_id>_det_test_car.txt
        output_dir = os.path.join(self._devkit_path, 'results', 'ADAS' + self._year, 'Main')
