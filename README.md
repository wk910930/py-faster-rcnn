...
[Here](http://blog.csdn.net/jiajunlee/article/details/50373815) (Chinese Version Only) supplies the solution to some common issues when build & deploy the project. Thank you [leejiajun](https://github.com/leejiajun)!
